...
start_bridge() {
  ...
  REMODEX_PAIRING_TTL_MS="${REMODEX_PAIRING_TTL_MS:-1800000}" \
  REMODEX_REFRESH_ENABLED="${REMODEX_REFRESH_ENABLED:-1}" \
  REMODEX_REFRESH_TRACE_FILE="${REMODEX_REFRESH_TRACE_FILE:-/tmp/remodex-refresh-trace.ndjson}" \
  REMODEX_REFRESH_DANCE_WINDOW_MS="${REMODEX_REFRESH_DANCE_WINDOW_MS:-4000}" \
  REMODEX_REFRESH_DEBOUNCE_MS="${REMODEX_REFRESH_DEBOUNCE_MS:-1800}" \
  REMODEX_REFRESH_FALLBACK_NEW_THREAD_MS="${REMODEX_REFRESH_FALLBACK_NEW_THREAD_MS:-2500}" \
  REMODEX_REFRESH_MIDRUN_THROTTLE_MS="${REMODEX_REFRESH_MIDRUN_THROTTLE_MS:-12000}" \
  REMODEX_REFRESH_ROLLOUT_LOOKUP_TIMEOUT_MS="${REMODEX_REFRESH_ROLLOUT_LOOKUP_TIMEOUT_MS:-5000}" \
  REMODEX_REFRESH_ROLLOUT_IDLE_TIMEOUT_MS="${REMODEX_REFRESH_ROLLOUT_IDLE_TIMEOUT_MS:-10000}" \
